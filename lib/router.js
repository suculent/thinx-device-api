...
module.exports = function(app) {
  ...
  if (typeof(github_ocfg) !== "undefined" && github_ocfg !== null) {
    ...
    app.get('/oauth/gcb', function(req, res) {
      ...
      console.log("GtHub OAuth request: ", {req}); // TODO: get some ID for global_response array to allow multiple requests at once without compromising security/availability
