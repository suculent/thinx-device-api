  ...
  */
  ...
  if (typeof (githubOAuth) !== "undefined") {
    ...
    githubOAuth.on('token', (oauth_token_string/* , serverResponse */) => {
      ...
      // console.log("[debug] [oauth] [github] githubOAuth on token", {oauth_token_string});
      ...
      var request_options = {
        ...
        headers: {
            ...
            'Authorization': 'Basic ' + new Buffer(opts.githubClient + ':' + opts.githubSecret).toString('base64')
        }
      }
