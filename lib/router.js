...
module.exports = function (app) {
  ...
  */
  ...
  // TODO: not used with google, the trackUserLogin must be called...
    ...
    githubOAuth.on('token', (oauth_token_string/* , serverResponse */) => {
      ...
      https.get(request_options, (res) => {
        ...
        res.on('end', () => {
          ...
          console.log("[debug] [github] [token] checkUserWithResponse with GitHub Access token:", token);
  ...
  app.get('/api/oauth/github/callback', function (req, res) {
    require("crypto").randomBytes(48, (err, buffer) => {
      ...
      redis_client.set("oa:github:" + token, 60); // TODO: validate on login
      let query = req.query; // used only for logging
