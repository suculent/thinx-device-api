...
module.exports = function (app) {
  ...
  */
  ...
  function checkMqttKeyAndLogin(req, cached_response, user_data) {
    ...
    user.mqtt_key(user_data.owner, function (success, key) {
      if (!success) {
        ...
        createMqttKeyAndCheck(req, cached_response, user_data);
        return;
      } else {
        console.log("🔨 [debug] [api/login] Found mqtt key", {key}); // TODO: FIXME: remove!
      }
  ...
  function createMqttKeyAndCheck(req, cached_response, user_data) {
