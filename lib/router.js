...
module.exports = function(app) {
  ...
  app.get("/slack/direct_install", function(req, res) {
    ...
    res.redirect(
      "https://slack.com/oauth/authorize?client_id=" + slack_client_id + "&scope=bot&state=Online&redirect_uri=" + app_config.public_url + "/slack/redirect"
    );
  });
  ...
  app.get("/slack/redirect", function(req, xres) {
    ...
    var options = {
      ...
      hostname: 'slack.com',
      port: 443,
      path: '/api/oauth.access?client_id=' + slack_client_id + '&client_secret=' + slack_client_secret + '&redirect_uri=' + app_config.public_url + '/slack/redirect&scope=bot&code=' +
        req.query.code
    };
