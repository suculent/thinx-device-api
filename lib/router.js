  ...
  */
  ...
  function checkUserWithResponse(response, token, userWrapper) {
    ...
    userlib.get(userWrapper.owner, (error, udoc) => {
      ...
      console.log("[checkUserWithResponse] using response with ourl: " + ourl);
    ...
    user.validate(username, (db_body) => {
      ...
      if (typeof (req.session) !== "undefined") {
        ...
        if ((typeof (req.body.remember) === "undefined") || (req.body.remember === 0)) {
          ...
          // this works
          res.cookie("x-thx-ws", expiration, {
            maxAge: 1 * hour,
            httpOnly: true,
            secure: false
          });
    ...
    githubOAuth.on('token', (oauth_token_string/* , resp, _res, req */) => {
      ...
      https.get(request_options, (res) => {
        ...
        res.on('end', () => {
          ...
          checkUserWithResponse(original_response, token, userWrapper);
