...
module.exports = function(app, _ws) {
  ...
  app.post("/device/register", function(req, res) {
    ...
    if (typeof(req.body) === "undefined") {
      ...
      */
      ...
      device.register(req, registration, req.headers.authentication, this._ws, function(success, response) {
  ...
  app.post("/api/build", function(req, res) {
    ...
    console.log("Starting build with notifiers:", {notifiers});
  ...
  app.post("/api/user/logs/tail", function(req, res) {
    ...
    blog.logtail(req.body.build_id, owner, this._ws, error_callback);
  });
