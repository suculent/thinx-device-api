...
module.exports = function (app) {
  ...
  */
  ...
  var global_response = null; // was stored in GET /api/oauth/github/callback; continued by checkUserWithResponse() in oauth.on.token
  ...
  app.get('/api/oauth/github/callback', function (req, res) {
    require("crypto").randomBytes(48, (err, buffer) => {
      if (gerr) throw new Error("[critical] crypto failure");
