    ...
    userlib.view("users", "owners_by_username", {
      ...
      for (var index in all_users) {
        ...
        if (username !== all_user_data.key) {
          console.log("Skipping user", all_user_data);
        } else {
      ...
      if (password.indexOf(user_data.password) !== -1) {
        ...
        user.create_default_acl(user_data.owner, () => {
          ...
          console.log("ACL refresh complete setting sessino owner...");
          ...
          if (typeof (req.session) !== "undefined") {
            ...
            if ((typeof (req.body.remember) === "undefined") ||
              ...
              req.session.cookie("x-thx-session", expiration, {
                maxAge: 24 * hour,
            ...
            userlib.get(user_data.owner, function (error, udoc) {
              if (error) {
                ...
                userlib.atomic("users", "checkin", user_data.owner, {
                  ...
                  console.log("[debug] [login] [last-seen] going to loginWithGDPR...");
                  req.session.owner = user_data.owner;
