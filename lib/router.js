...
module.exports = function (app) {
  ...
  function auditLogin(owner, req) {
    // Make note on user login
    userlib.get(owner, (error, udoc) => {
      if (error) {
        console.log("[OID:" + owner + "] owner get error: " + error);
      } else {
  ...
  app.post("/api/login", function (req, res) {
    ...
    userlib.view("users", "owners_by_username", {
      "key": username,
      "include_docs": false // required for password, but this anyway returns whole doc so wtf? maybe this creates the additional issue somewhere later
    }, (err, db_body) => {
