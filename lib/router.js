...
module.exports = function (app) {
  ...
  */
  ...
  console.log("[info] ℹ️ Bootstrapping completed.");

  var getClientIp = function (req) {
    var ipAddress = req.ip;
    if (!ipAddress) {
      console.log("[warning] ⚠️ Unknown Client IP:" + ipAddress);
      return false;
    }
  ...
  app.post("/api/login", function (req, res) {
    ...
    if ((typeof (token) !== "undefined") && (token !== null)) {
      ...
      console.log("[info] [/api/login] Performing Token login with session", {debug_session});
    ...
    user.validate(username, (db_body) => {
      ...
      if (typeof(db_body) === "undefined" || (db_body == null) || (db_body === false)) {
        console.log("[error] ☣️ [/api/login] No db_body, ", db_body, "for user", username);
      ...
      if (user_data === null) {
        ...
        console.log(`[error] ☣️ No user data, '${username}' not authorized.`);
      ...
      if ((typeof (deleted) !== "undefined") && (deleted === true)) {
        console.log("[info] [D6] user deleted.");
