...
module.exports = function(app) {
  ...
  console.log("Loaded module: API Environment");
  ...
  console.log("Loaded module: Buildlog");
  ...
  app.all("/*", function(req, res, next) {
    ...
    console.log("router with client_ip", client_ip);
  ...
  app.post("/api/login", function(req, res) {
    ...
    console.log("Searching for password-hash", password, "in username", username);
    ...
    userlib.view("users", "owners_by_username", {
      ...
      console.log("comparing", password, "to", user_data.password);
