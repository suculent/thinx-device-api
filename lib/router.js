...
module.exports = function(app) {
  ...
  app.post("/api/device/mesh/attach", function(req, res) {
    ...
    devices.attachMesh(owner, body, function(success, status) {
      console.log("Responding to mesh/attach");
      respond(res, {
        success: success,
        attached: status
      });
  ...
  app.post("/api/device/mesh/detach", function(req, res) {
    if (!(validateSecurePOSTRequest(req) || validateSession(req, res))) return;
    devices.detachMesh(req.session.owner, req.body, function(success, status) {
  ...
  app.post("/api/mesh/delete", function(req, res) {
    ...
    console.log("POST api/mesh/delete with incoming body:", req.body);
    ...
    user.deleteMeshes(owner_id, mesh_ids, function(success, status) {
      console.log("Mesh delete success:", success, "ids", status);
