...
module.exports = function (app) {
  ...
  */
  ...
  app.get('/api/oauth/github', function (req, res) {
    ...
    */
    if (typeof (githubOAuth) !== "undefined") {
        console.log('[debug] [oauth] [github] Starting Login with token', token);
  ...
  app.get('/api/oauth/cb', async (req, res) => {
    ...
    try {
      ...
      const gat_url = 'https://www.googleapis.com/oauth2/v1/userinfo?alt=json&access_token=' + accessToken;
