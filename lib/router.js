...
module.exports = function(app) {
  ...
  function responder(success, status) {
    respond(res, {
      success: success,
      attached: status
    });
  ...
  app.post("/api/device/attach", function(req, res) {
    ...
    var owner = req.session.owner;
    var body = req.body;
    devices.attach(owner, body, responder);
  });
  ...
  app.post("/api/device/mesh/attach", function(req, res) {
    ...
    devices.attachMesh(owner, body, responder);
  });
  ...
  app.post("/api/device/data", function(req, res) {
    ...
    app.messenger.data(owner, udid, responder);
  ...
  app.post("/api/device/revoke", function(req, res) {
    if (!(validateSecurePOSTRequest(req) || validateSession(req, res))) return;
    devices.revoke(req.session.owner, req.body, responder);
  });
  ...
  app.post("/api/transformer/run", function(req, res) {
    ...
    device.run_transformers(udid, owner, responder);
  });
  ...
  app.post("/api/user/rsakey/revoke", function(req, res) {
    ...
    if (typeof(req.body.filenames) !== "undefined") {
      ...
      rsakey.revoke(owner, filenames, responder);
    } else {
      respond(res, {
        success: false,
  ...
  app.post("/api/user/create", function(req, res) {
    user.create(req.body, true, responder);
  });

  // /user/delete POST
  /* Delete user document */
  app.post("/api/user/delete", function(req, res) {
    user.delete(req.body, responder);
  });
