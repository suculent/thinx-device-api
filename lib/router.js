...
module.exports = function (app) {
  ...
  app.post("/device/addpush", function (req, res) {
    ...
    if (typeof (req.body) === "undefined") {
      ...
      device.push(registration, req.headers.authentication, 
        (success, response) => {
        respond(res, response);
      });
    }
  ...
  app.post("/api/device/envs", function (req, res) {
    device.envs(req.body.udid, (success, response) => {
      respond(res, response);
    });
  });
  ...
  app.post("/api/device/detail", function (req, res) {
    device.detail(req.body.udid, (success, response) => {
      respond(res, response);
    });
  });
  ...
  app.post("/api/login", function (req, res) {
    ...
    user.validate(username, (db_body) => {
      ...
      if (client_type == "webapp") {
        ...
        user.create_default_acl(user_data.owner, (ignored) => {
