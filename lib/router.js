...
module.exports = function (app) {
  ...
  var global_token = null; // should be object like oauth_token[req.query.code or owner] but is actually in redis as well, what a mess
  ...
  function loginWithGDPR(req, res, user_data, client_type) {
    ...
    if (typeof (req.session.owner) !== "undefined") {
      ...
      // Invalid session should cause session flush and logout
