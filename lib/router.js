...
module.exports = function (app) {
  ...
  */
  ...
  function validateSession(req) {
    ...
    console.log("[debug] validating session", session);
  ...
  function rejectLogin(req, user_data, password) {

    if (typeof (user_data) === "undefined" || (user_data == null) || (user_data === false)) {
      console.log("☣️ [error] [/api/login] No user_data for user", username);
  ...
  app.post("/api/login", function (req, res) {
    ...
    user.validate(username, (db_body) => {
      ...
      if (rejectLogin(req, user_data, password)) return;
