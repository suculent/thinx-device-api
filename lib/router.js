...
module.exports = function (app) {
  ...
  const JWTLogin = require("./thinx/jwtlogin"); var login = new JWTLogin(redis_client);
  login.init(() => {
    console.log("[info] JWT Login Secret Init Complete. Login is now possible.");
  });
  ...
  app.all("/*", function (req, res, next) {
    ...
    login.verify(req, (result) => {
      console.log("[info] JWT Secret verification result:", {result});
    });
