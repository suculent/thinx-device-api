...
module.exports = function (app) {
  ...
  app.post("/api/login", function (req, res) {
    ...
    console.log("[/api/login] client_type:", client_type, "res:", res);
    ...
    user.validate(username, (db_body) => {
      ...
      */
      ...
      if (typeof (req.session) !== "undefined") {
        ...
        console.log("[/api/login] [D5] assigning session/cookie"); // here the request/response seems to be still OK
      ...
      console.log("[D7]", {res}); // here the response is already fault
      ...
      if (client_type == "webapp") {
        ...
        user.create_default_acl(user_data.owner, (result) => {
