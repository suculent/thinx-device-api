...
module.exports = function (app) {
  ...
  app.post("/api/login", function (req, res) {
    ...
    console.log("[debug] [removeme] Incoming login response:", {res}); // TODO: FIXME: Highly dangerous, leaks user credentials!
    ...
    userlib.view("users", "owners_by_username", {
            ...
            userlib.get(user_data.owner, (error, udoc) => {
              if (error) {
                ...
                userlib.atomic("users", "checkin", user_data.owner, {
                  ...
                  console.log("loginWithGDPR with res", {res});
      ...
      // console.log("login successfull, redirecting to app authentication route...");
