...
module.exports = class Platform {
    ...
    getPlatform(local_path, callback) {
		...
		// TODO: Assign platforms by plugin implementations instead of this, extact matching functions! Functions should return name or null and need no separate unit testing being always called only from here.
    ...
    getPlatformFromPath(local_path) {
		...
		if (typeof (yml) !== "undefined") {
			...
			console.log("[repository] platform from thinx.yml: " + platform);
