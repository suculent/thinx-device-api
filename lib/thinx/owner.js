...
var Owner = (function() {
  ...
  var prefix = Globals.prefix();
	...
	function sendActivationEmail(new_owner_hash, new_activation_token, email, firsst_name, last_name, username, callback) {
				...
				userlib.view("users", "owners_by_username", {
					...
					*/
					...
					userlib.insert(new_user, new_owner_hash, function(err,
						...
						sendActivationEmail(new_owner_hash, new_activation_token, email, firsst_name, last_name, username, callback);
					}); // insert
					});
				}); // view
