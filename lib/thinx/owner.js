...
var Owner = (function() {
				...
				password_reset: function(owner, reset_key, callback) {
					...
					userlib.view("users", "owners_by_resetkey", {
						...
						if (reset_key != user_reset_key) {
							...
							// FIXME: Should redirect to HTTPS!
							callback(true, {
								redirectURL: 'http://rtm.thinx.cloud:80/password.html?reset_key=' +
						...
						activate: function(ac_owner, ac_key, callback) {
							...
							userlib.view("users", "owners_by_activation", {
								...
								if (err === true) {
									...
									callback(true, {
										redirectURL: 'http://rtm.thinx.cloud:80/password.html?activation=' +
		...
		exports.create = Owner.create; exports.update = Owner.update; exports.password_reset =
		Owner.password_reset; exports.password_reset_init = Owner.password_reset_init; exports
		.activate = Owner.activate; exports.set_password = Owner.set_password;
