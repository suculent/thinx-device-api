...
module.exports = class JWTLogin {
    ...
    fetchOrCreateSecretKey(callback) {
        this.redis.get(JWT_KEY, (err, result) => {
            if ((err !== null) || (result == null)) {
                this.createSecretKey((key) => {
                    console.log("[jwt] Created signing key", key);
                ...
                console.log("[jwt] Fetched signing key", result);
                callback(result);
            }
        });
    }
    ...
    sign(uid, callback) {
        ...
        this.fetchOrCreateSecretKey((secretkey) => {
            ...
            console.log("[jwt] Fetched or created signing key", secretkey);
            ...
            console.log("[jwt] signing payload", payload, "with secretkey", secretkey);
    ...
    verify_impl(req, callback) {
        ...
        console.log("[jwt] verify token", token, "with secretkey", sck);
