...
const AuditLog = require("./audit"); var alog = new AuditLog();
const Auth = require('./auth');
const Deployment = require("./deployment"); var deploy = new Deployment();
const Device = require("./device");
const Git = require("./git"); var git = new Git();
const Platform = require("./platform");
const Sanitka = require("./sanitka"); var sanitka = new Sanitka();
const Sources = require("./sources"); let sources = new Sources();
...
module.exports = class Devices {
	...
	attach(owner, body, callback, res) {
		...
		devicelib.get(udid, (pre_attach_err, pre_attach_body) => {
			...
			var device_path = Filez.deployPathForDevice(doc.owner, doc.udid);
