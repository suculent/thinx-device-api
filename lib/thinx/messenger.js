...
module.exports = class Messenger {
	...
	init() {
		...
		this.master.on("reconnect", () => {
			...
			console.log("[TODO:FIXME] Restart mosquitto or use shell command: mosquitto_passwd -b ", app_config.mqtt.passwords, app_config.mqtt.username, mqtt_password);
			const CMD = "mosquitto_passwd -b " + app_config.mqtt.passwords + " " + app_config.mqtt.username + " " + mqtt_password;
