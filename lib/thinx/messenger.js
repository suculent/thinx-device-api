...
module.exports = class Messenger {
	...
	init() {
		...
		var mqtt_password = this.password; // this is default password for testing purposes
		...
		console.log("MQTT connect with config", mqtt_config); // TODO: FIXME! REMOVE AFTER USE!
		...
		this.master.on("error", (error) => {
			if (error.toString().indexOf("Not authorized") !== -1) {
				console.log("[OID:MASTER] MQTT waiting for authorization...");
			} else {
