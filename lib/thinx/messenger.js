...
module.exports = class Messenger {
	...
	init() {
		...
		var mqtt_password = "mosquitto"; // this is default password for testing purposes
		var mqtt_username = "thinx-api-mqtt-account";

		mqtt_password = process.env.MOSQUITTO_PASSWORD; // TODO: FIXMENOW! RANDOMIZE!!!
		...
		this.master.on("reconnect", () => {
			console.log("[OID:MASTER] MQTT reconnecting...");
		});
