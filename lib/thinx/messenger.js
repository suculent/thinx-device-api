	...
	var _public = {
		...
		data: function(owner, callback) {
			...
			client.keys("/*" + owner + "*", function(err, replies) {
				...
				var get_result_or_callback = function(reply, i, callback, results) {
					...
					client.get(reply, function(err, json_keys) {
						...
						if (err) {
							...
							// TODO: Decode Base64
							console.log("Stringified Keys: " + JSON.stringify(keys));
				...
				replies.forEach(function(reply, i) {
					console.log("    " + i + ": " + reply);
					get_result_or_callback(reply, i, callback, results);
				});
