...
module.exports = class Messenger {
	...
	createInstance() {
		...
		this.init();
		console.log("[messenger::createInstance] Initializing Slack...");
		this.initSlack();
		return this;
	}
	...
	init() {
		...
		console.log("[messenger::init] Messenger instance will attempt to connect to", app_config.mqtt.server);
