...
module.exports = class Transfer {
	...
	migrate_device(original_owner, xudid, recipient, body, json_keys, callback) {
		...
		device.edit(xudid, changes, (success, xchanges) => {
	...
	request(owner, body, callback) {
		...
		// Generic Check
		if ((typeof (body.to) === "undefined") || (body.to === null)) return callback(false, "missing_recipient");

		if ((typeof (body.udids) === "undefined") || (body.udids === null)) return callback(false, "missing_subject");
