...
module.exports = class ACL {
    ...
    load_redis(callback) {
        ...
        try {
            let racls = this.client.smembers(query + ":racls"); // get for array?
        ...
        try {
            let wacls = this.client.smembers(query + ":wacls"); // get for array?
        ...
        try {
            let rwacls = this.client.smembers(query + ":rwacls"); // get for array?
