...
module.exports = class ACL {
    ...
    commit_redis(callback) {
        ...
        console.log("Committing user ACL:", user);
        ...
        if (user.length > 0 && user !== null) {
            ...
            console.log("Committing ACLS to redis:");

            client.sadd(this.current_user + ":racls", racls, (error, reply) => {
                console.log(error, reply);
            });

            client.sadd(this.current_user + ":wacls", wacls, (error, reply) => {
                console.log(error, reply);
            });

            client.sadd(this.current_user + ":rwacls", rwacls, (error, reply) => {
                console.log(error, reply);
            });
