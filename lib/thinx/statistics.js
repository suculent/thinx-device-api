...
module.exports = class Statistics {
	...
	constructor() {
		...
		this.parser = null;
		this._owner = "0fbe2e3d9326d4b318476c8a26b4ac93d38cf7da69b04204822a3bff102dc622"; // test owner only
	...
	get_all_owners() {
		...
		this.owners = { "0fbe2e3d9326d4b318476c8a26b4ac93d38cf7da69b04204822a3bff102dc622" : Statistics.get_owner_template() }; // test owner only
		...
		this.extract_docker_logs(() => {
			...
			fs.copy(this.LOG_PATH, this.TEMP_PATH, (err) => {
				...
				this.parser.on("close", (line) => {
					...
					console.log("Closing aggregate parser with results (this.owners list): ");
