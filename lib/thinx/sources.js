...
module.exports = class Sources {
	...
	*/
	...
	withRepository(info, local_path) {
		...
		// get all users
		// - we have owner_id from local_path:
		// Selecting /mnt/data/repos/baecb3124695efa1672b7e8d62e5b89e44713968f45eae6faa52066e87795a78/19168ab0-a5db-11ea-a77c-33912a38673f/95a8fac0-ab0f-11ea-96b8-398016833d6d/keyguru-firmware-zion/.git

		// remove app_config.data_root + app_config.build_root + "/";
		// split by '/' and take beginning, this is owner_id
