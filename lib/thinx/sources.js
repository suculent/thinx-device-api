	...
	var _public = {
		...
		add: function(owner, alias, url, branch, callback) {
			...
			mkdirp(REPO_PATH, function(err) {
				...
				// TODO: FIXME: NO BRANCH SUPPORT -b " + branch + "
				var CMD = "cd " + REPO_PATH + "; git clone " + url +
				...
				var REPO_INNER_PATH = REPO_PATH + "/" + directories[0]; // FIXME: Must be last line of what CMD returns?

				// TODO: only of existsSync
