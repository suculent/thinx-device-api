...
console.log("Repository.js: Globals not defined on start...");
} else {
console.log("Repository.js: Globals already defined on start.");
}

var Repository = (function() {

	console.log("Loading repository globals...");
		...
		process_hook: function(info) {
			...
			if (repo_gits) {
				for (var dindex in repo_gits) {
					if (repo_gits[dindex].indexOf(full_name) != -1) {
