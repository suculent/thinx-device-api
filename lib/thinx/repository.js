...
var Repository = (function() {
	...
	var gh = githooked("push", function(info) {
		...
		console.log("githooked function called:");
		console.log(JSON.stringify(info));


		results = search.recursiveSearchSync(name, app_config.project_root +
			app_config.build_root);
		console.log("Found repositories: " + JSON.stringify(results));

		if (typeof(thix.exit_callback) === "undefined") {
		...
		for (var rindex in repositories) {
			...
			console.log("TODO: Find this repository locally; git pull & rebuild...");
			this.checkRepositoryChange(local_path, false, this.exit_callback);
		}
	...
	var _public = {
		...
		watchRepository: function(local_path, callback) {
			...
			console.log("Starting repository watcher on " + local_path);
