...
module.exports = class Repository {
	...
	process_hook(info) {
		...
		console.log("[repository.js:watch] Finding latest and deleting rest...");

		console.log(repositories);

		// NEW -> DELETE ALL BUT LATEST
		...
		for (var rindex = 0; rindex < repositories.length; rindex++) {
			...
			let device_path = local_path_array.splice(local_path_array.length-2, 2);
