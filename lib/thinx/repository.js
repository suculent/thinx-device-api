...
var devices = new Devices(); // we need Devices but without messenger, only the DB access...
...
module.exports = class Repository {
	...
	constructor() {
		...
		this.exit_callback = (status, repository) => {
			console.log("Empty this.exit_callback with status", status, "should be used to start a BUILD", repository);
