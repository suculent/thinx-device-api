...
module.exports = class Repository {
	...
	static findAllRepositories() {
		...
		console.log("[findAllRepositories] Search completed with repos:", repo_gits.length, "in", repositories_path;
		return repo_gits;
	}
	...
	static findAllRepositoriesWithFullname(full_name) {
		...
		var repositories = [];
		console.log("[findAllRepositoriesWithFullname] Searching repos with fullname: ", full_name, "in", repo_gits );
				...
				for (let source_id of source_ids) {
					...
					devices.udidsWithSource(owner_id, source_id, (udids) => {
						...
						for (let udid of udids) {
							console.log("Device with this source:", udid);
