...
module.exports = class Repository {
	...
	safe_git_path(unsanitized_path, repeat, check_callback) {
		...
		if (!this.check_local_path_early_exit(local_path, check_callback)) return false;

		// now the gitdir should be really valid
		if (!this.check_git_dir_valid(local_path, owner_id, check_callback)) return false;

		if (!this.check_git_dir_exists(local_path, check_callback)) return false;
