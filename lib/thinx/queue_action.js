...
module.exports = class Action {
    ...
    setStarted() {
        ...
        this.redis.v4.set(key, contents).then(() => {
            this.redis.v4.expire("queue:"+this.action.udid, 20*60); // 20 minutes max build time
        });
    }
