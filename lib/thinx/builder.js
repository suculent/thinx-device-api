...
var Builder = (function() {
	...
	var _private = {
		...
		buildCommand: function(build_id, owner, git, udid, dryrun) {
			...
			console.log("[BUILD] Fetching device " + udid + " for owner " + owner);
				...
				apikey.list(owner, function(success, json_keys) {
					...
					mkdirp(BUILD_PATH, function(err) {
						if (err) {
							...
							console.log("Builder GIT Fetch result: " + fetch_result);
							...
							repository.getPlatform(BUILD_PATH, function(success, platform) {
								...
								console.log("Trying to fetch GIT tag...");
								...
								try {
									...
									console.log(
										"TODO: HIDE THIS: Exception while getting git tag: " + e
									);
									git_tag = "1.0";
								}
								if (git_tag === null) {
								...
								console.log("REPO_VERSION (TAG+REV): " + REPO_VERSION);
