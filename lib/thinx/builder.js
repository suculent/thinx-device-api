...
module.exports = class Builder {
	...
	runRemoteShell(CMD, owner, build_id, udid, notifiers) {
		...
		console.log("TODO: Just a copy, fixme!");

		// This will be replaced by a socket to worker...
	...
	run_build(build_id, owner, git, branch, udid, dryrun, notifiers, workers, callback) {
					...
					apienv.list(owner, (list_success, api_envs) => {
						...
						apienv.list(owner, (env_list_success, keys) => {
							...
							if (workers.length == 0) {
								...
								this.runRemoteShell(workers[0], owner, build_id, udid);
							}
