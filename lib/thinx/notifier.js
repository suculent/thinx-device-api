...
module.exports = class Notifier {
    ...
    */
    ...
    process(job_status, callback) {
        ...
        const thinx_firmware_version = job_status.thinx_firmware_version; // build resul
        ...
        devicelib.get(udid, (err, doc) => {
            ...
            devicelib.view("devicelib", "devices_by_source", {
                ...
                console.log("FIXME: Construct proper artifact path!");

                const apath = "/mnt/data/deploy" + job_status.owner_id + "/" + job_status.udid + "/" + job_status.build_id + "/" + job_status.build_id + ".zip";
