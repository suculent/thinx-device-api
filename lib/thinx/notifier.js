...
module.exports = class Notifier {
    ...
    */
    ...
    process(job_status, callback) {
        ...
        const thinx_firmware_version = job_status.thx_version; // build resul
        ...
        if (typeof (env_hash) === "undefined" || env_hash === null) {
            let env_path = job_status.build_path + "/environment.json";
            console.log("[lib/notifier.js] Notifier searching for environments...");
            if (fs.existsSync(env_path)) { // lgtm [js/path-injection]
        ...
        devicelib.get(udid, (err, doc) => {
            ...
            devicelib.view("devicelib", "devices_by_source", {
                ...
                const apath = job_status.build_path + "/" + job_status.build_id + ".zip";
