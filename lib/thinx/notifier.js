...
let devicelib = require("./couch")(db_uri).use(prefix + "managed_devices"); // lgtm [js/unused-local-variable]
        ...
        devicelib.get(udid, (err, doc) => {
            ...
            devicelib.view("devices", "devices_by_source", {
                ...
                if (job_status.status.indexOf("OK") !== -1) {
                    InfluxConnector.statsLog(job_status.owner, EventTaxonomy.NAMES.BUILD_SUCCESS, job_status.build_id);
                } else {
