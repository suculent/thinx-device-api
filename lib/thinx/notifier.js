...
module.exports = class Notifier {
    ...
    constructor() {
        console.log("[lib/notifier.js] initializing notifier class...");
    }
    ...
    process(job_status) {
        ...
        var repo_url = job_status.git_repo; // reference to git repo
        ...
        var thinx_firmware_version = job_status.thx_version; // build result status
        
        let outfile = job_status.outfile;
        
        let md5; // build result status
        var env_hash = job_status.env_hash;

        console.log("[lib/notifier.js] De-briefing build:");
        ...
        if (typeof (env_hash) === "undefined" || env_hash === null) {
            ...
            console.log("[lib/notifier.js] Notifier searching for environments...");
            if (fs.existsSync(env_path)) {
                env_hash = this.getFileSHA(env_path);
                console.log("[lib/notifier.js] Notifier-generated ENV_HASH:", env_hash);
            } else {
