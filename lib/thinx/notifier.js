...
module.exports = class Notifier {
    ...
    notificationObject(newStatus, buildEnvelope) {
        ...
        if (newStatus === true || newStatus.indexOf("OK") === 0) {
            ...
            alertObj = {
                text: "Dry run successful. Firmware left undeployed.", // TODO (19): Show also reference git_url + commit_id; https://github.com/suculent/thinx-device-api/issues/312
                username: "notifier.js",
                icon_emoji: ":ghost:",
                fields: buildEnvelope
            };
    ...
    process(job_status, callback) {
        ...
        devicelib.get(udid, (err, doc) => {
            ...
            devicelib.view("devices", "devices_by_source", {
                ...
                console.log(`[info] [notifier.js] Deploying build envelope: ${deployedEnvelopePath}`);
                ...
                console.log(`[info] [notifier.js] STATUS: ${job_status.status}`);
