...
var Deployment = (function() {
  ...
  var app_config = Globals.app_config();
	...
	function _deployPathForOwner(owner) {
		var user_path = app_config.data_root + app_config.deploy_root + "/" +
			owner;
		return user_path;
	}

	function _pathForDevice(owner, udid) {
	...
	var _private = {
		...
		_latestFirmwareEnvelope: function(owner, udid) {
		...
		getAvailableVersion: function(owner, udid) {
			...
			var envelope = _private._latestFirmwareEnvelope(owner, udid);
