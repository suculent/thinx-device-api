...
module.exports = class Deployment {
	...
	deployPathForOwner(owner) {
		let v_owner = Validator.owner(owner); // TODO: refactor to sanitka or expect only boolean result
	...
	latestFirmwarePath(in_owner, udid) {
		var owner = in_owner;
		// FIXME: Find out, why this happens (in_owner is whole object instead of identifier) - log callee
