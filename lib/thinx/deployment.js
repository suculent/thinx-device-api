...
module.exports = class Deployment {
	...
	platformSupportsUpdate(device) {
		...
		if (typeof(device.platform) !== "undefined") {
			console.log("platformSupportsUpdate searches in device platform: " + device.platform);
	...
	latestFirmwarePath(in_owner, udid) {
		...
		if (!fs.existsSync(dpath)) { // lgtm [js/path-injection]
			return false;
		}
