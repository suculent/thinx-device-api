  ...
  var app_config = Globals.app_config();
	...
	var _public = {
		...
		list: function(owner, callback) {
			const key_paths = _public.getKeyPathsForOwner(owner);
	...
	var revokeUserKeys = function(revoked_filenames, owner) {
		var revoked_keys = [];
		const key_paths = _public.getKeyPathsForOwner(owner);
	...
	var revokeUserKeysAndCallback = function(revoked_filenames, owner, callback) {
