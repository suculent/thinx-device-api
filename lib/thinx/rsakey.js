...
module.exports = class RSAKey {
	...
	create(owner, callback) {
		...
		const result = exec.execSync(GENERATE_KEYS); // TODO: process result and possible errors properly...
		console.log("TODO process result: (should be 0 like errorcode)", {result});
