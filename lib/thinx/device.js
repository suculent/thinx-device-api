				...
				devicelib.destroy(existing._id, existing._rev,
					...
					function(err) {
						...
						if (err) {
							...
							console.log("Destroyed existing device: " + existing._id);
						}
						...
						if (typeof(reg.udid) === "undefined" || reg.udid === "") {
							...
							if (typeof(existing.udid) === "undefined") {
								existing.udid = existing._id;
								console.log("Device found but creating new udid: " + existing.udid);
							} else {
								console.log("Device found with udid: " + existing.udid);
							}
						}
