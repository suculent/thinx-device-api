		...
		edit: function(owner, changes, callback) {
			...
			if (udid !== null) {
				...
				if (typeof(changes.status) != "string") {
					// We do not support intentionally any complex data types here
					// and mainly WE DO NOT LOG MQTT TRAFFIC!
					// console.log("Device update skipped for complex MQTT status data.");
					return;
				}
