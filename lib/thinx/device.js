...
module.exports = class Device {
	...
	firmware(req, callback) {
		...
		console.log("[debug] [device.js] F1");
		...
		console.log("[debug] [device.js] F2");
		...
		console.log("[debug] [device.js] F3");
		...
		apikey.verify(firmware_owner, api_key, false, (success, message) => {
			...
			console.log("[debug] [device.js] F4");

			devicelib.get(udid, (err, device) => {

				if (err) {
					console.log("device get in firmware failed", err);
					callback(false, "device get in firmware failed");
					return;
				}

				console.log("[debug] [device.js] F5");
				...
				console.log("[debug] [device.js] F6");

				// Check update availability
				var updateAvailable = deploy.hasUpdateAvailable(device);

				console.log("[debug] [device.js] F7");
				...
				this.client.get("nid:" + udid, (get_err, json_keys) => {
					...
					console.log("[debug] [device.js] F8");

					deploy.latestFirmwarePath(firmware_owner, udid, (path) => {
						console.log("[info] latestFirmwarePath completed with", {path});

						console.log("[debug] [device.js] F9");
						...
						console.log("[debug] [device.js] F10");
						...
						if (updateAvailable) {
							...
							console.log("[debug] [device.js] F11");
