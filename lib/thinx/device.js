...
module.exports = class Device {
	...
	update_device(udid, changes, update_callback) {
		...
		devicelib.get(udid, (err, doc) => {
			...
			console.log("atomic device updated document", doc);

			delete doc._rev;

			devicelib.atomic("devicelib", "modify", udid, doc, (atomic_err, body) => {
				if (atomic_err) {
					...
					console.log("atomic device updated with changes", changes);
