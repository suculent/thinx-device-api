...
var Device = (function() {
	...
	console.log("Device loading globals...");
	var Globals = require("./globals.js");
  var app_config = Globals.app_config();
  var prefix = Globals.prefix();
  //var rollbar = Globals.rollbar();
	console.log("Device loaded prefix "+prefix);

	console.log("Device loading fs...");
	...
	console.log("Device loaded vars...");
