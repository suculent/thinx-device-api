	...
	firmware(req, callback) {
		...
		apikey.verify(firmware_owner, api_key, null, (success, message) => {
			...
			devicelib.get(udid, (err, device) => {
				...
				console.log("[info] Getting latest firmware update descriptor from envelope with: " + device.udid);
				...
				console.log("[info] Seaching for possible firmware update... (owner:" + device.owner + ")");
