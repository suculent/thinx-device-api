    ...
    console.log("update_device_and_respond udid:", udid, "device:", device);
      ...
      var alias_or_owner = device.owner;
          ...
          udid: udid
			...
			var device_time = momentTz.tz(timezone).unix();
      //device_time = momentTz.unix().tz(timezone);
          ...
          delete registration_response.registration.alias;
          delete registration_response.registration.timestamp;
				...
				if (typeof(device.transformers) !== "undefined" && device.transformers !== null) {
                  ...
                  try {
                    console.log("[device] transformer_decode64_exception " + e);
  									...
  									console.log("[device] TRANSFORMER FATAL transformer_decode128_exception " + e);
                  ...
                  console.log(" ERR: " + err);
							...
							devicelib.insert(device, udid, (err, body, header) => {
								if (!err) {
									...
									var device_time = moment(new Date()).tz(timezone_abbr).unix();
