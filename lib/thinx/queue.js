...
module.exports = class Queue {
    ...
    setupSocket(socket) {
        ...
        socket.on('job-status', function (job_status) {
            console.log("[queue.js] » Incoming job status:", msg);
            if (job_status.status == "OK") {
                console.log("TODO: CHECK REIMPLEMENTED NOTIFIER!");
                notifier.process(job_status);
            }
        });
