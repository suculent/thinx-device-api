...
module.exports = class Queue {
    ...
    findNext(callback) {
        this.redis.keys("queue:*", (error, action_keys) => {
        if (action_keys === null) {
            return callback(false, "findNext get keys error");
        }
        ...
        for (let i = 0, len = action_keys.length; i < len; i++) {
            ...
            this.redis.get(action_key, (error, contents) => {
