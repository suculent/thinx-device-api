...
module.exports = class Queue {
    ...
    findNext() {
        ...
        for (const action_key of action_keys) {
            ...
            let action = new Action(udid).withString(redis.get(action_key));
            ...
            if (pruneIfCompleted(action)) continue;
    ...
    runNext(action) {
        ...
        this.builder.build(owner, build, [], function(success, message, build_id) {
            action.delete();
