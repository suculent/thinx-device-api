...
module.exports = class Queue {
    ...
    constructor(builder, di_app, ssl_options, opt_thx) {
    ...
    runNext(action, worker) {
        ...
        if ((typeof (worker) === "undefined") || (worker === null) || (worker === false)) {
            console.log("⚠️ [warning] runNext called with empty worker, skipping, will set error for action", action);
            action.setError();
            return;
        }
