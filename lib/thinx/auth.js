...
module.exports = class Auth {
	...
	add_mqtt_credentials(username, password) {
		// debug only, REMOVE!:
		console.log("adding mqtt credentials:", username, password);
		if (this.use_plugin) {
	...
	add_mqtt_credentials_go(username, password) {
		...
		if ((typeof(password) == "undefined") || (password == null)) {
			console.log("DEVELOPER ERROR: Invalid password provided for hashing.");
			return;
		}

		console.log("Adding MQTT credentials (GO-Redis) for username", username);
