...
module.exports = class Auth {
	...
	add_mqtt_credentials(username, password, callback) {
		console.log("configuring app credentials in mosquitto", username, password); // TODO: FIXME: Security risk
		if (this.use_plugin) {
			console.log("using redis backend");
			this.add_mqtt_credentials_go(username, password, callback);
		} else {
			console.log("using files backend");
			this.add_mqtt_credentials_impl(username, password, callback);
		}

	}

	add_mqtt_credentials_go(username, password, callback) {
	...
	add_mqtt_credentials_impl(username, password, callback) {
