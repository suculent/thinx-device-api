...
module.exports = class APIKey {
	...
	save_apikeys(owner_id, api_key_array, api_key_object, callback) {
		this.client.set("ak:" + owner_id, JSON.stringify(api_key_array), (/* nerr */) => {
			let response_data = api_key_array;
	...
	verify(owner, apikey, is_http, callback) {
		...
		if ((typeof(owner) === "undefined") || (owner === null)) callback(false);
		if ((typeof(apikey) === "undefined") || (apikey === null)) callback(false);
			...
			if ((typeof (json_keys) !== "undefined") && (json_keys !== null)) {
				if (this.key_in_keys(apikey, json_keys)) {
					...
					new InfluxConnector('stats').writePoint({
						...
						tags: { owner_id: owner, hash: apikey },
						fields: { value: 1 },
					});
