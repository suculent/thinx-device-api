...
function deleteMesh(req, res) {
    ...
    this.user.deleteMeshes(owner_id, mesh_ids, function (success, status) {
...
function getListMeshes(req, res) {
    ...
    this.user.listMeshes(owner_id, (success, mesh_ids) => {
...
function createMesh(req, res) {
    ...
    this.user.createMesh(owner_id, mesh_id, mesh_alias, (success, response) => {
...
module.exports = function (app) {
    ...
    var user = new User(app.redis_client);
