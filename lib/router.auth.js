...
const User = require("./thinx/owner");
...
module.exports = function (app) {
    ...
    var user = new User(redis_client);
    ...
    function performTokenLogin(req, res, oauth) {
        ...
        redis_client.get(oauth, function (err, userWrapper) {
            if (err) {
                auditLogError(userWrapper.owner, "oauth_token_not_found");
                ...
                userlib.get(owner_id, function (gerr, doc) {
                    ...
                    if (gerr) {
                        ...
                        this.user.create(wrapper, false, res, (_response, success, status) => {
                        ...
                        this.user.updateLastSeen(doc, false);
    ...
    function checkMqttKeyAndLogin(req, cached_response, user_data) {
        ...
        this.user.mqtt_key(user_data.owner, function (success, key) {
            if (!success) {
    ...
    function loginAction(req, res) {
        ...
        this.user.validate(username, (db_body) => {
