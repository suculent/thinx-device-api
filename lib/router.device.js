...
const Sanitka = require("./thinx/sanitka"); var sanitka = new Sanitka(); // only class methods (should be refactored)
const Device = require("../lib/thinx/device"); // only class methods
...
function editDevice(req, res) {
  ...
  this.device.edit(changes, (success, message) => {
...
function getDeviceDetail(req, res) {
  ...
  this.device.detail(udid, (_success, response) => {
...
function setDeviceEnvs(req, res) {
  ...
  this.device.envs(udid, (_success, response) => {
    Util.respond(res, response);
  });
}
...
function runTransformer(req, res) {
  ...
  this.device.run_transformers(udid, owner, Util.responder, res);
}

module.exports = function (app) {

  var devices = new Devices(app.messenger, app.redis_client);
  var device = new Device(app.redis_client);
