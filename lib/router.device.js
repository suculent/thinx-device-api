...
module.exports = function (app) {
  ...
  function editDevice(req, res) {
    if (!Util.validateSession(req)) return res.status(401).end();
    if (typeof (req.body) === "undefined") return Util.responder(res, false, "missing_body");
    if (typeof (req.body.changes) === "undefined") return Util.responder(res, false, "missing_changes");
