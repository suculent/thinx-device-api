        ...
        userlib.get(userWrapper.owner, (error, udoc) => {
            ...
            if (error) {
                ...
                user.create(userWrapper, false, response, (/* res, success, status*/) => {
                    ...
                    if (Globals.use_sqreen()) {
                        if (typeof (app.sqreen) !== "undefined") app.sqreen.signup_track({ username: owner_id });
                    }
    ...
    function secureGithubCallbacks(original_response, callback) {
        ...
        githubOAuth.on('token', (oauth_token_string, resp, /* _res, req */) => {
            ...
            if (typeof (oauth_token_string) === "object") {
                ...
                2022-05-13T09:12:00.439270614Z   access_token: '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',
                2022-05-13T09:12:00.439414264Z   token_type: 'bearer',
                2022-05-13T09:12:00.439502213Z   scope: 'user'
                2022-05-13T09:12:00.439603888Z 
                */
                access_token = oauth_token_string.access_token;
            }
