    ...
    */
    ...
    function secureGithubCallbacks(original_response, callback) {
        ...
        githubOAuth.on('token', (oauth_response, /* resp, _res, req */) => {
            ...
            console.log("[github] debug token event without token (will redirect to error):", { oauth_response });
            ...
            if (!Util.isDefined(oauth_response)) {
                ...
                */
                original_response.end(401);
                console.log("Intruder alert.");
                return;
            }

            let access_token = typeof (oauth_response) === "object" ? oauth_response.access_token : undefined;
