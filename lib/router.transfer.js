...
module.exports = function (app) {
  ...
  function postAcceptTransfer(req, res) {
    ...
    if (!Util.isDefined(sanitka.udid(req.body.transfer_id))) return Util.failureResponse(res, 400, "transfer_id_missing");
    if (!Util.isDefined(sanitka.owner(req.body.owner))) return Util.failureResponse(res, 400, "owner_missing");
    if (!Util.isDefined(req.body.udids)) return Util.failureResponse(res, 400, "udids_missing");
