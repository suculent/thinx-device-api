...
# AQUA_SEC_TOKEN / SNYK_TOKEN intentionally absent: the scanners run as
# CircleCI jobs, never inside this image. Declaring them as ENV baked the
# live values into the published (public) thinxcloud/api layers.
