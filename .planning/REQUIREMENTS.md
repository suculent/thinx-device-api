...
- [x] **REFACTOR-07**: `fs-finder` is removed from `package.json` `dependencies` and no source reference to it remains (verified by `grep` clean + `npm ls fs-finder` resolving to nothing).
