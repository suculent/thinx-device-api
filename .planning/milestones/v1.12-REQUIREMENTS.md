...
Requirements for the v1.12 Inbox Drawdown milestone. Each maps to exactly one roadmap phase. Sourced from `/gsd-inbox` triage of open GitHub issues; scoped task notes in `.planning/archive/inbox-tasks/`.
