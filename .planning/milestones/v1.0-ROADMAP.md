...
**Goal:** Restore swarm-side auto-redeploy on `micro` so that a parent-monorepo push triggering a registry image build results in a rolling task update without operator intervention.
**Mode:** mvp
